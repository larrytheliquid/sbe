...
\subsubsection{Definition of Realizability Predicate}
...
\subsubsection{Realizability Predicate Reification}
...
\subsubsection{Evaluation into Realizability Predicate}

\begin{theorem}[Predicate Evaluation]
\label{thm:ep:eval}
$$
\forall (a : \type{A}) (\sigma : \menv).~ \dtypm{A}(\sigma ~ a)
$$
\end{theorem}

\subsubsection{Other Lemmas}
