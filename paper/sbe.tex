...
\todo[inline]{abstract should be max 150 words}
...
semantic value of a Kripke model~\cite{kripkemodel}, and then reifying the result to a syntactic value
...
function within a language based on Martin-L{\"o}f Type Theory~\cite{nordstrom1990programming}.
...
use De Bruijn~\cite{TODO} variables. For example, our typing rule
