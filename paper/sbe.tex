...
Thus, normalization can be more simply defined as the composition of
...
evaluation? Now evaluating the function produces a model
...
%% the expression using the big-step semantics terminates at some
%% value.

\subsection{Normalization by Evaluation}

So far we have seen the model of values and have some intuition for
why it makes writing a terminating definition of evaluation possible.
Now let's take a closer look at how exactly to define normalization in
terms of evaluation. What additional theorems 
...
\paragraph{Evaluation (\refthm{TODO} in \refsec{TODO})}
$$
\fun{eval} : \type{A} \marr \menv \marr \dtypm{A}
$$

\paragraph{Reification (\refthm{TODO} in \refsec{TODO})}
$$
\fun{reify} : \typm{A} \marr \typv{A}
$$

\paragraph{Identity Model Environment (\refthm{TODO} in \refsec{TODO})}
$$
