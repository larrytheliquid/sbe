...
For example, Keller and Altenkirch~\cite{hsubagda} show how to formalize the
...
There are many different ways to define the semantics and prove the
termination of a total $\lambda$-calculus, so how does SbE change the
story? First, consider the various options 
