...
\newcommand{\con}[1]{\textrm{#1}}
\newcommand{\fun}[1]{\textrm{#1}}
...
\todo[inline]{BNF grammar for types}

\todo[inline]{BNF grammar for contexts}

\section{Intrinsic Typing of De Bruijn Variables as Context Membership}
...
\section{Intrinsic Typing of Expressions for G{\"o}del's System T}
