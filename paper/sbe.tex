...
termination proofs as definig an intrinsic semantics that simplifies
definitions in the metatheory, and provides you free theorems, in
analogy to intrinsic types. The paper is second about showing how
