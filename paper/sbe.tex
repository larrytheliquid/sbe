...
($\midenv$) can be used by reflecting the context. In contrast, hereditary substitution already has
...
\begin{mytheorem}{Context Reflection}{midenv}
{ \midenv : \midenvT }
{
\refsec{TODO} & \refthm{TODO} & $\reflectn$ & $\reflectnT$ \\
\hline
