...
\newcommand{\typm}[1]{\el{\Gamma \vdash #1 \rrbracket}}
\newcommand{\dtypm}[1]{\el{\Delta \vdash #1 \rrbracket}}
\newcommand{\ctypm}[2]{\el{\Gamma , #1 \vdash #2 \rrbracket}}
...
\newcommand{\env}[1]{\fun{Env} ~ \Gamma ~ #1}
...
\\      & {\exists (e' : A). ~ e \Downarrow e' \wedge \fun{IsNormal} ~ e'} }
\end{displaymath}
...
%% \begin{displaymath}
%%     \xymatrix{
%%           {\forall (v : \typv{A}) (\sigma : \env{\Delta})} \ar[dr] 
%%             \ar[r]
%%         & {\dtypm{A}} \ar[d]
