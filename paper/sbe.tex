...
is of a model value in the terminal context ($\Delta$),
...
$$
\eval : \type{A} \marr \menv \marr \dtypm{A}
$$

\paragraph{Reification (\refthm{TODO} in \refsec{TODO})}
$$
\reify : \typm{A} \marr \typv{A}
$$
...
expression and creating an identity model environment, mapping
syntactic variables in any context to variables as model values in the
same context.
